...
<html>
	 ...
	 */
	$('#formTable').datagrid({
	    url:'/ezsh/merchantA/select',
	    columns:[[
			{field:'merchantId',hidde:true,title:'商家ID',width:100,align:'center'},
			{field:'pManagerId',hidden:'true',title:'管理处ID',width:100,align:'center'},
			{field:'managerName',title:'管理处名称',width:100,align:'center'},
			{field:'merchantName',title:'商家名称',width:100,align:'center'},
			{field:'merchantLinkPhone',title:'联系电话',width:100,align:'center'},
			{field:'merchantDescr',title:'商家描述',width:100,align:'center'}
	    ]]
	});
