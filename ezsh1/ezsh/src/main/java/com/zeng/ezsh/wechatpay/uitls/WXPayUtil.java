...
public class WXPayUtil {
	...
	/**
	 * 用Md5进行签名，生成带有 sign 的 XML 格式字符串 
	 *
	 * @param data Map类型数据
	 * @param key API密钥
	 * @return 含有sign字段的XML
	...
	/**
	 * @author qwc 2018年1月21日 下午10:14:52
	 * @param data
	 * @param key
	 * @param signType
	 * @return
	 ...
	 * @description 生成带有sign的Map
	 */
	public static Map<String, String> generateSignedMap(
			final Map<String, String> data, String key, SignType signType)
			throws Exception {
		String sign = generateSignature(data, key, signType);
		data.put(WXPayConstants.FIELD_SIGN, sign);
		return data;
